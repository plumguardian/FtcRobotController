...
@Disabled // FIXME: Disabled
@SuppressWarnings("BusyWait")
@Autonomous(name = "Move Forward And Back", group = TeamCode.GROUP_NAME)
public class MoveForwardAndBack extends LinearOpMode {
    @IgnoreConfigurable // FIXME: Disabled
    @Configurable
    private static class AutoMoveConfigPanels {
        // Don't manually change values. Control it with panels.
        public static int moveDist = 10_000;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        for (int move = 0; move < AutoMoveConfigPanels.moveDist; move++) {
            ...
            mecanumDrive.driveRobotCentric(0, AutoMoveConfigPanels.movePower, 0);
        }
